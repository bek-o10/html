...
<div class="fixed-top header_section haeder_main" style="background-color:white; ">
      ...
      <nav class="navbar navbar-light justify-content-between">
         ...
         <form class="form-inline ">
            <div class="login_text">
               <ul>
                  <li><a href="Login/index.php"><img src="images/user-icon.png"></a></li>
                  <li><a href="korzina.php"><img src="images/trolly-icon.png"></a></li>
                  <li><a href="searchMobiles.php"><img src="images/search-icon.png"></a></li>
               </ul>
            </div>
         </form>
      </nav>
